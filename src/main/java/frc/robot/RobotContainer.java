...
public class RobotContainer {
  ...
  private Command intakeSpit, intakeSpitBoost, intakeVacuum, intakeVacuumBoost;
  ...
  private void configureIntakeCommands() {
    intakeVacuum = new StartEndCommand(
        () -> intake.vacuum(),
        () -> intake.off(),
        intake);
    intakeVacuumBoost = new StartEndCommand(
        () -> intake.vacuumBoost(),
        () -> intake.off(),
        intake);
    intakeSpit = new StartEndCommand(
        () -> intake.spit(),
        () -> intake.off(),
        intake);
    intakeSpitBoost = new StartEndCommand(
      () -> intake.spitBoost(), 
      () -> intake.off(), 
      intake);
  }
  ...
  private void bindXboxButtons() {
    intakeVacuumButton.and(boostTrigger.negate()).whileActiveOnce(intakeVacuum);
    intakeSpitButton.and(boostTrigger.negate()).whileActiveOnce(intakeSpit);

    intakeVacuumButton.and(boostTrigger).whileActiveOnce(intakeVacuumBoost);
    intakeSpitButton.and(boostTrigger).whileActiveOnce(intakeSpitBoost);
  }
